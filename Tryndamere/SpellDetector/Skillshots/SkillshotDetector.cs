...
using SharpDX;
using Tryhardamere.SpellDetector.Helpers;
using Collision = Tryhardamere.SpellDetector.Helpers.Collision;
using SpellSlot = Tryhardamere.SpellDetector.Targeted.SpellSlot;

#endregion

namespace Tryhardamere.SpellDetector.Skillshots
{
